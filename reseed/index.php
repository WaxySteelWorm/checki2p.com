    ...
    <div class="message">
        ...
        while($row = $result->fetch_assoc()) {
            ...
            if ($row["status"] == "offline") {
                echo "<td><img src='../assets/images/offline.svg' alt='Offline' class='status-icon'> OFFLINE since " . $row["last_checked"] . "</td>";
            } else {
                echo "<td><img src='../assets/images/online.svg' alt='Online' class='status-icon'> ONLINE</td>";
            }
            echo "</tr>";
